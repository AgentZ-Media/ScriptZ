...
export const de = {
  ...
  "handoff.intro": "Übergibt die markierten Inhalte einmalig an ein ScriptZ Studio. Den Empfangs-Code erzeugst du dort.",
  "handoff.selection": "Auswahl: {summary}",
  "handoff.code.label": "Empfangs-Code",
  "handoff.code.placeholder": "scriptz1_…",
  "handoff.code.hint": "In Studio in der Kundenansicht „Vom Editor empfangen“ öffnen und den Code hier einfügen.",
  "handoff.target": "Sendet an {host}",
  "handoff.target.labeled": "Sendet an {host} - {label}",
  ...
  "handoff.error.badCode": "Ungültiger oder unvollständiger Code.",
  "handoff.error.insecureUrl": "Der Code zeigt auf eine unsichere Adresse (kein HTTPS).",
  "handoff.error.empty": "Nichts ausgewählt.",
  "handoff.error.network": "Verbindung fehlgeschlagen. Prüfe Internet und Code.",
  "handoff.error.invalidToken": "Der Code ist ungültig.",
  "handoff.error.tokenUsed": "Dieser Code wurde bereits verwendet. Erzeuge in Studio einen neuen.",
  "handoff.error.tokenExpired": "Der Code ist abgelaufen. Erzeuge in Studio einen neuen.",
