...
export const en: Record<keyof typeof de, string> = {
  ...
  "handoff.title": "Send to ScriptZ Studio",
  "handoff.intro": "Transfers the selected items to your ScriptZ Studio.",
  "handoff.selection": "Selection: {summary}",
  "handoff.loading": "Loading destinations from Studio…",
  "handoff.client.label": "Client",
  "handoff.client.placeholder": "Choose a client…",
  "handoff.folder.label": "Folder",
  "handoff.folder.none": "Inbox (no folder)",
  "handoff.retry": "Try again",
  "handoff.deleteAfter": "Move to local trash after sending",
  "handoff.send": "Send",
  "handoff.sending": "Sending…",
  "handoff.toast.success": "Sent {summary} to Studio",
  "handoff.toast.partial": "Only {accepted} of {total} transferred - the rest stays local.",
  "handoff.error.empty": "Nothing selected.",
  "handoff.error.network": "Connection failed. Check your internet connection.",
  "handoff.error.invalidKey": "The Studio key is invalid. Check the connect code in the settings.",
  "handoff.error.keyRevoked": "The Studio key has been revoked. Generate a new one in Studio and enter it in the settings.",
  "handoff.error.invalidTarget": "The chosen client or folder no longer exists. Reload the destinations.",
  "handoff.error.noTargets": "No client exists in Studio yet.",
  "handoff.error.tooManyItems": "Too many items at once. Send them in smaller groups.",
  "handoff.error.rejected": "The transfer was rejected.",
  "handoff.error.generic": "Transfer failed ({code}).",
  ...
  "settings.section.studio": "Studio",
  ...
  "settings.studio.sub": "Connection to ScriptZ Studio for transferring scripts and ideas directly.",
  "settings.studio.code.label": "Connect code",
  "settings.studio.code.placeholder": "scriptzk1_…",
  "settings.studio.code.help": "The agency generates the code in ScriptZ Studio under Administration → Editor connection. Without a code, the app shows no Studio features.",
  "settings.studio.connect": "Connect",
  "settings.studio.connecting": "Connecting…",
  "settings.studio.connected": "Connected to {host}",
  "settings.studio.test": "Test connection",
  "settings.studio.test.ok_one": "Connection OK - found {count} client.",
  "settings.studio.test.ok_other": "Connection OK - found {count} clients.",
  "settings.studio.disconnect": "Disconnect",
  "settings.studio.error.badCode": "Invalid or incomplete connect code.",
  "settings.studio.error.insecureUrl": "The code points to an insecure address (no HTTPS).",
  "settings.studio.toast.connected": "Connected to ScriptZ Studio",
  "settings.studio.toast.disconnected": "Studio connection removed",
