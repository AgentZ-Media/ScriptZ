...
export const en: Record<keyof typeof de, string> = {
  ...
  "handoff.intro": "Hands the selected items over to a ScriptZ Studio once. You generate the receive code there.",
  "handoff.selection": "Selection: {summary}",
  "handoff.code.label": "Receive code",
  "handoff.code.placeholder": "scriptz1_…",
  "handoff.code.hint": "In Studio, open “Receive from editor” in the client view and paste the code here.",
  "handoff.target": "Sends to {host}",
  "handoff.target.labeled": "Sends to {host} - {label}",
  ...
  "handoff.error.badCode": "Invalid or incomplete code.",
  "handoff.error.insecureUrl": "The code points to an insecure address (no HTTPS).",
  "handoff.error.empty": "Nothing selected.",
  "handoff.error.network": "Connection failed. Check your internet and the code.",
  "handoff.error.invalidToken": "The code is invalid.",
  "handoff.error.tokenUsed": "This code has already been used. Generate a new one in Studio.",
  "handoff.error.tokenExpired": "The code has expired. Generate a new one in Studio.",
